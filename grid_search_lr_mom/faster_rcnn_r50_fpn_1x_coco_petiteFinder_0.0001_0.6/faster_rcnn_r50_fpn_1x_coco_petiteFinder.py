...
optimizer = dict(type='SGD', lr=0.0001, momentum=0.6, weight_decay=0.0001)
...
classes = ('g', 'p')
work_dir = '/media/groot/HDD_storage/work_dirs/faster_rcnn_r50_fpn_1x_coco_petiteFinder_0.0001_0.6'
gpu_ids = range(0, 1)
